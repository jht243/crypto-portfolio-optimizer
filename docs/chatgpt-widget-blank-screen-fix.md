...
2. **Absolute Script URLs with Regular src Attribute**
   ```html
   <script type="module" src="https://crypto-portfolio-optimizer.onrender.com/assets/crypto-portfolio-optimizer.js"></script>
   ```
...
-->
<script type="module">
  import('https://crypto-portfolio-optimizer-svpa.onrender.com/assets/crypto-portfolio-optimizer.js')
    .catch(err => {
